...
func (a *APIHandler) initRouter(g *gin.RouterGroup) {
	...
	g.POST("/relay/fill/start", func(c *gin.Context) { a.ApiService.StartRelayFill(c, GetLoginUser(c)) })
	g.GET("/relay/fill/status", func(c *gin.Context) { a.ApiService.GetRelayFill(c, GetLoginUser(c)) })
	g.POST("/relay/fill/stop", func(c *gin.Context) { a.ApiService.StopRelayFill(c, GetLoginUser(c)) })
	...
	g.POST("/agents/:id/relay/fill/start", a.ApiService.StartAgentRelayFill)
	g.GET("/agents/:id/relay/fill/status", func(c *gin.Context) { a.ApiService.AgentRelayFillControl(c, false) })
	g.POST("/agents/:id/relay/fill/stop", func(c *gin.Context) { a.ApiService.AgentRelayFillControl(c, true) })
