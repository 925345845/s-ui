...
**最新版本 Latest:** [v1.5.3](https://github.com/Hhz0823/1s-ui/releases/tag/v1.5.3)
...
# 指定版本
bash <(curl -Ls https://raw.githubusercontent.com/Hhz0823/1s-ui/main/install.sh) v1.5.3
...
```bash
opkg install ./s-ui-lite_1.5.3-1_x86_64.ipk
