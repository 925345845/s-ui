...
**最新版本 Latest:** [v1.5.2](https://github.com/Hhz0823/1s-ui/releases/tag/v1.5.2)
...
# 指定版本
bash <(curl -Ls https://raw.githubusercontent.com/Hhz0823/1s-ui/main/install.sh) v1.5.2
...
```bash
opkg install ./s-ui-lite_1.5.2-1_x86_64.ipk
