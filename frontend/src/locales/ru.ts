export default {
  ...
  relay: {
    ...
    partialResult: "Requested {requested}: created {created}, skipped {skipped}.",
    partialHint: "Successful rows keep their original IPv4/IPv6 pairs. Skipped rows were not created; copy the report and retry them separately after resolving the failures.",
    copySkipped: "Copy skipped rows",
    skippedRow: "Original row {row}",
    verifyEgress: "Check Internet connectivity before creation",
    verifyEgressHint: "Off by default: create all locally prepared rows for testing on your websites. When enabled, only rows passing Internet checks are created.",
    egressUnchecked: "Internet connectivity was not checked. Test on your actual websites.",
    pairedPlan: "Prepare {count} IPv6 addresses paired with upstreams in original row order. Internet checks are off by default.",
