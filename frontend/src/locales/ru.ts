export default {
  ...
  relay: {
    ...
    verifyEgressHint: "On by default: filter failed addresses and match usable IPv6. Each IPv6 takes up to about 32 seconds; batch time scales with count (about 20 minutes for 500 failing candidates).",
    egressUnchecked: "Internet connectivity was not checked. Test on your actual websites.",
    pairedPlan: "Prepare {count} IPv6 candidates, check them and match usable IPv4 upstreams in order. Create only the available pairs.",
