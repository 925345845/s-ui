export default {
  ...
  relay: {
    ...
    fillRunning: "Filling in the background. Saved nodes are ready to use.",
    ...
    fillHint: "Generate and test IPv6 replacements until every IPv4 is matched or you stop. Successful rounds are saved as relay pools. Filling continues when the page closes.",
    pairedPlan: "Keep filling usable IPv6 for {count} IPv4 upstreams. Replace failed candidates and save successful rounds immediately.",
