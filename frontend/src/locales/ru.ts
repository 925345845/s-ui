export default {
  ...
  relay: {
    ...
    creatingHint: "Paired creation checks both IPv4 upstreams and IPv6 egress with batch deadlines. Please do not submit again.",
    ...
    pairedPlan: "Prepare {count} IPv6 addresses paired with upstreams in row order. Create only rows that pass checks; skip failed rows.",
