export default {
  ...
  agent: {
    ...
    addresses: "Addresses",
    note: "Agents connect outbound over WebSocket (Nezha/Komari style). Remote control requires a live WS session.",
  ...
  relay: {
    ...
    upstreamListHint: "One host:port:username:password per line, or socks5://username:password{'@'}host:port",
    create: "Create relay",
