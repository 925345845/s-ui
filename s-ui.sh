...
custom_version() {
    ...
    download_link="https://raw.githubusercontent.com/Hhz0823/1s-ui/master/install.sh"
...
update_shell() {
    wget -O /usr/bin/s-ui -N --no-check-certificate https://github.com/Hhz0823/1s-ui/raw/master/s-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
